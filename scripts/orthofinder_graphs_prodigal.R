...
data <- read.table("/media/sarlab/DATA/Bacillus_project/Bacillus_project_orthofinder/Results_Jul01/Graphs/species_specific_orthogroups.txt", header=FALSE, col.names=c("Isolates", "IsolatesSpecificOrthogroups"))
...
ggsave(paste0("/media/sarlab/DATA/Bacillus_project/Bacillus_project_orthofinder/Results_Jul01/Graphs/no_of_isolate_specific_ogs",".png"),
...
# Read the sorted data into R
data_gene_perc <- read.table("/media/sarlab/DATA/Bacillus_project/Bacillus_project_orthofinder/Results_Jul01/Graphs/percofgenes_inogs_per_isolate.txt", header=FALSE, col.names=c("Isolates", "PercentageinOgs"))
...
ggsave(paste0("/media/sarlab/DATA/Bacillus_project/Bacillus_project_orthofinder/Results_Jul01/Graphs/perc_of_genes_in_ogs_plot",".png"),
       plot=PercOfOgs_plot, 
       height = 20, 
       width = 50,
       dpi = 300, 
...
# Read the sorted data into R
data_gene_all_any <- read.table("/media/sarlab/DATA/Bacillus_project/Bacillus_project_orthofinder/Results_Jul01/Graphs/orthogroupcount_in_isolates.txt", header=TRUE, sep = "\t")
...
ggsave(paste0("/media/sarlab/DATA/Bacillus_project/Bacillus_project_orthofinder/Results_Jul01/Graphs/no_of_genes_with_ogs_inanyorall",".png"),
       plot=SharedOgs_plot, 
       height = 20, 
       width = 50,
       dpi = 300, 
...
ggsave(paste0("/media/sarlab/DATA/Bacillus_project/Bacillus_project_orthofinder/Results_Jul01/Graphs/collective_orthofinder_graph",".png"),
