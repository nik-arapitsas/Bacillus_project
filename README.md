...
This repository documents the computational pipeline used to assemble, annotate, and do comparative genomics and functional analyses on the genomes of 25 Bacilli endophytes.
